...
public class Mechanic implements Entity<String> {
    ...
    public LocaleString getDescription() { return description; }
    public void setDescription(LocaleString description) { this.description = description; }
    @Override public String getID() { return mechanicId; }
    @Override public void setID(String s) { this.mechanicId = s; }
}
